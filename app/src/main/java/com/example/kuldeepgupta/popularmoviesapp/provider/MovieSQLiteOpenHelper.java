package com.example.kuldeepgupta.popularmoviesapp.provider;
...
import com.example.kuldeepgupta.popularmoviesapp.BuildConfig;
...
public class MovieSQLiteOpenHelper extends SQLiteOpenHelper {
    ...
    public static final String SQL_CREATE_TABLE_MOVIE = "CREATE TABLE IF NOT EXISTS "
            ...
            + MovieColumns.MID + " INTEGER NOT NULL, "
            + MovieColumns.TITLE + " TEXT NOT NULL, "
            + MovieColumns.RELEASEDATE + " TEXT, "
            + MovieColumns.POSTERPATH + " TEXT, "
            + MovieColumns.PLOTSYNOPSIS + " TEXT, "
            + MovieColumns.USERRATING + " REAL, "
            + MovieColumns.POSTERSAVELOC + " TEXT "
            + ", CONSTRAINT unique_mid UNIQUE (mid) ON CONFLICT REPLACE"
            + " );";
