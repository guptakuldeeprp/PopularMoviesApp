...
import com.example.kuldeepgupta.popularmoviesapp.provider.base.BaseContentProvider;
...
public class MovieProvider extends BaseContentProvider {
    ...
    public static final String AUTHORITY = "com.example.kuldeepgupta.popularmoviesapp.provider";
